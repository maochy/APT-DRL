...
from network import CTMaskableDQN
from network.DQNMaskablePolicy import DQNMaskablePolicy

class CTMaskableDDQN(CTMaskableDQN):
    ...
    def __init__(
        ...
        super(CTMaskableDDQN, self).__init__(
            policy,
            env,
            learning_rate,
            buffer_size,
    ...
    def train(self, gradient_steps: int, batch_size: int = 100, option_name: str = "") -> None:
        ...
        for _ in range(gradient_steps):
            ...
            with th.no_grad():
                ...
                # obtain best action from q_net and use it for getting the next_q_values
