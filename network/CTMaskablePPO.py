...
from util.init_framework import to_torch
...
class CTMaskablePPO(OnPolicyAlgorithm):
    """
    ...
    def _setup_model(self) -> None:
        ...
        self.rollout_buffer.to_torch = types.MethodType(to_torch, self.rollout_buffer)
    ...
    def collect_rollouts(
        ...
        # self.globel.compute_returns_and_advantage()
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                clip_fraction = th.mean((th.abs(ratio - 1) > clip_range).to(th.get_default_dtype())).item()
